...
namespace LoggService
{
    public static class CustomConsoleThemeList
    {
        public static CustomConsoleTheme GetSpecialThemeWithConsoleThemeStyle { get; } = new CustomConsoleTheme(new Dictionary<ConsoleThemeStyle, string>
        {
